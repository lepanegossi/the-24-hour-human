...
.heroclock{width:158px;height:158px;margin:0 auto 18px;border-radius:50%;flex:0 0 auto;
...
@media(max-height:930px){
 ...
 .heroclock{width:124px;height:124px;margin-bottom:14px}
...
/* The clock steps down with the screen instead of jumping straight to small: at a
   813px viewport the scroll cue already sits 56px off the bottom edge, so every
   pixel the clock gains has to come out of that margin. Measured, not guessed. */
@media(max-height:860px){.heroclock{width:100px;height:100px;margin-bottom:12px}}
@media(max-height:760px){.heroclock{width:84px;height:84px}}
/* below this the clock is the one element the hero can lose without losing meaning.
   The threshold was 680px, which left a 1366x768 screen (681px of viewport) two
   pixels over the fold with the scroll cue cut off. */
