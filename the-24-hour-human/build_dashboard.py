...
.tcard i{position:absolute;top:16px;left:18px;z-index:1;font-style:normal;font-size:28px;
...
const TOPICS=[
  {k:'pca',ic:'&#128564;',img:'personal-care',col:COL[0],unit:'h',
  ...
  {k:'paw',ic:'&#128188;',img:'paid-work',col:COL[1],unit:'h',
   name:'Paid work',
...
tgrid.innerHTML=TOPICS.map((t,i)=>`<button class="tcard" type="button" data-i="${i}"
   ...
   <i>${t.ic}</i><b>${t.name}</b></button>`).join('');
