...
/* ──────────────── the double shift: one image, two beats ────────────────
   The climax carried the heaviest text on the page and two bar charts. The scene
   is a block of flats at night with one kitchen light still on: the second shift
   without reducing anyone to a person with a broom. Measured luminance 4.4, so it
   sits inside the night band instead of punching a hole in it. */
.shiftimg{position:relative;border-radius:var(--r);overflow:hidden;margin-bottom:24px;
...
<section class="reveal">
  ...
  <figure class="shiftimg">
    ...
    <figcaption class="shiftcap">Long after the paid day ends, somewhere a light is still on. <b>This is the shift no payslip counts.</b></figcaption>
  </figure>
